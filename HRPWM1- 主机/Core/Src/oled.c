...
不能同时两个都同时取消注释！
在stm32cubemx中初始化时需要将SCL和SDA引脚的"user lable"分别设置为I2C1_SCL和I2C1_SDA。
*/
...
#define OLED_SDA            I2C1_SDA_Pin // SDA
#define OLED_SCL_GPIO_Port  I2C1_SCL_GPIO_Port
#define OLED_SDA_GPIO_Port  I2C1_SDA_GPIO_Port

/*STM32G474芯片的硬件I2C1: PA8 -- SCL; PC9 -- SDA */
